...
export const currentStepTracking: Scenario = {
  ...
  async run(h) {
    ...
    h.emitEvent(proj, "iteration.started", runId, {
      iteration_path:
        proj.project_root + "/.pipeline/test-pipeline/steps/01-hello.md",
      index: 1,
    });
    ...
    h.emitEvent(proj, "iteration.completed", runId, {
      ...
      outcome: "completed",
      next_iteration_path:
        proj.project_root + "/.pipeline/test-pipeline/steps/02-world.md",
      has_improvement_brief: false,
      has_blocker_delegation: false,
      halt_reason: null,
      terminal: false,
    ...
    h.emitEvent(proj, "iteration.completed", runId, {
      ...
      outcome: "completed",
      next_iteration_path:
        proj.project_root + "/.pipeline/test-pipeline/steps/03-done.md",
      has_improvement_brief: false,
      has_blocker_delegation: false,
      halt_reason: null,
      terminal: false,
...
export const pipelineDiscovery: Scenario = {
  ...
  description: "scanPipelines finds the fixture pipeline under .pipeline/test-pipeline",
  async run(h) {
