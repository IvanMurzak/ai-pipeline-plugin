...
This pipeline is a fixture — it's never actually executed by `step-executor`. The harness only references its files to give the daemon something realistic to discover under `.pipeline/test-pipeline/`.
