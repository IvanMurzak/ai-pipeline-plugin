...
// The CLI-side WRITER, imported for the round-trip case only. Same
// cross-package test import resolve-parity.test.ts already uses; nothing
// shipped imports across the two apps at runtime.
import { registerDriveSessionBinding } from "../../pipeline-cli/src/lib/event.ts";
import { newId } from "../../pipeline-cli/src/lib/ids.ts";
